...
[Devrait expliquer stride aussi] ==> https://machinelearningmastery.com/pooling-layers-for-convolutional-neural-networks/
...
https://machinelearningmastery.com/pooling-layers-for-convolutional-neural-networks/ ==> Removes sensitity to positon of things in image, downsampling to just "presence or not" of feature
...
https://pyimagesearch.com/2016/09/12/softmax-classifiers-explained/ ==> Softmax = ce que le multilayer perceptron fait. Pourrait le mentionner dans la section plus haut, pas vraiment besoin ici.
